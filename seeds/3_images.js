  ...
  return knex('images').del()
    .then(function () {
      ...
      return knex('images').insert([
        ...
        {
          id: 3, caption: 'Paola is crossfit Queen', imageUrl: 'http://r.ddmcdn.com/s_f/o_1/cx_462/cy_245/cw_1349/ch_1349/w_720/APL/uploads/2015/06/caturday-shutterstock_149320799.jpg',
          created_at: new Date('2017-04-24 10:23:16 UTC'),
          updated_at: new Date('2017-04-24 10:23:16 UTC')
        }
      ]);
